...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a4cdfb610a7bdc79c4cd50db44abb15afb774ff2cad999c6db8fdd8ed9b097a1.js',function(){input.required=false;search();});}
