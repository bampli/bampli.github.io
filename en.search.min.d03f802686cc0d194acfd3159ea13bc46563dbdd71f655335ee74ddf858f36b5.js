...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.c0ce00f54d9da6462d4a0817c430866b841276f7a28e363fce2e8c51a926e247.js',function(){input.required=false;search();});}
