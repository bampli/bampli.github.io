...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6361efec3abfea2cd1e8f72ecdabee6639d2d782030337a3f0999dd6f1a1c994.js',function(){input.required=false;search();});}
