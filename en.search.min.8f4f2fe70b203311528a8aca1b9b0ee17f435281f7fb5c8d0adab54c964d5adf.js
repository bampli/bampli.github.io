...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5a1dc70bc91100e0924efe8626e259e0780a7e90b1dbcf51465d895c298dafdb.js',function(){input.required=false;search();});}
